	...
	<div class="banner">
		...
		<div id="mySidenav" class="sidenav">
			...
			<a href="javascript:void(0)" class="closebtn" onclick="closeNav()"><img src="../assets/img/arrow.png" alt="" style="width: 50px; height: 50px;  transform: translate(100%, 450%);"></a>
				<a href="Student_Profile.php"><img src="../assets/img/girl.jpg" alt="" style="width: 100px; height: 135px; border-radius: 50% ;"></a>
				<div class="text">
				<a href="../student/student_answerQuestion.php">Answer Questions<br>& Give Feedback</a>
				</div>
		</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto text-primary">
						<li class="nav-item active">
							<a class="nav-link" href="../student/student_home.php">Home <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="../student/student_profile.php">Profile</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="../student/student_activity.php">Activities</a>
						</li>
						<li class="nav-item">
